...
Проектные документы лежат вне репозитория, в `..\docs\`, и остаются русскими.

## Авторство коммитов

**Не добавляйте Claude соавтором.** Ни `Co-Authored-By`, ни другой трейлер,
приписывающий авторство модели. Автор коммита — человек, который за него отвечает.
